...
public class Appui_Double extends Appui{
    ...
    public FormatDeRetourSystemNoeuds Generation_Syteme(int Colones, int Pos) {
        ...
        */
        ...
        //Dans les deux lignes qui suivent, on complete le system avec les inconnus en x et en y de la réaction de l'appui double, respectivement dans les colones pos et pos + 1 
        SystemeNoeud.set(0, Pos, 1);
        SystemeNoeud.set(0, Pos+1, 1);
